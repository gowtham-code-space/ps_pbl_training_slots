...
export const pointsService = {
  getRewardRanking({ course, year = 'ALL', search = '', limit = 20, offset = 0 } = {}) {
    return api.get('/points/reward', {
      params: { course, year, search, limit, offset },
    });
  },

  getActivityIndividualRanking({ course, year = 'ALL', search = '', limit = 20, offset = 0 } = {}) {
    return api.get('/points/activity/individual', {
      params: { course, year, search, limit, offset },
    });
  },

  getGroupAverageRanking({ search = '', limit = 20, offset = 0 } = {}) {
